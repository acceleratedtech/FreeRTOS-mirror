...
DSTATUS disk_initialize (XSpi SpiInstance, BYTE pdrv);
DSTATUS disk_status (BYTE pdrv);
DRESULT disk_read (XSpi SpiInstance, BYTE pdrv, BYTE* buff, DWORD sector, UINT count);
DRESULT disk_write (XSpi SpiInstance, BYTE pdrv, const BYTE* buff, DWORD sector, UINT count);
